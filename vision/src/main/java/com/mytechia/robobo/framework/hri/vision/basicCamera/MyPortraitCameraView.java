...
// Original class https://github.com/CMU-Robotics-Club/QBot-Mobot/blob/master/app/src/main/java/edhyah/com/qbot/PortraitCameraView.java
// All from http://answers.opencv.org/question/7313/rotating-android-camera-to-portrait/
public class MyPortraitCameraView extends CameraBridgeViewBase implements Camera.PreviewCallback {
    ...
    public MyPortraitCameraView(Context context, int cameraId) {
        super(context, cameraId);
    }

    public MyPortraitCameraView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//        Log.d(TAG, "Preview Frame received. Frame size: " + frame.length);
    ...
    private class CameraWorker implements Runnable {
        ...
        public void run() {
            do {
                synchronized (MyPortraitCameraView.this) {
                    try {
                        ((Object) MyPortraitCameraView.this).wait();
                    } catch (InterruptedException e) {
